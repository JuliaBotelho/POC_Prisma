...
export function userValidation(req, res, next) {
    return __awaiter(this, void 0, void 0, function () {
        var user, error, errors;
        return __generator(this, function (_a) {
            user = req.body;
            error = userSchema.validate(user, { abortEarly: false }).error;
            if (error) {
...
export function movieValidation(req, res, next) {
    return __awaiter(this, void 0, void 0, function () {
        var movie, error, errors;
        return __generator(this, function (_a) {
            movie = req.body;
            error = movieSchema.validate(movie, { abortEarly: false }).error;
            if (error) {
                errors = error.details.map(function (detail) { return detail.message; });
                return [2 /*return*/, res.status(422).send(errors)];
            }
