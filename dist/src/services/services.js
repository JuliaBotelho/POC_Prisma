...
export function isAbletoFavourite(movieId, userId) {
    return __awaiter(this, void 0, void 0, function () {
        var movieSelected;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, checkIfReviewed(movieId)];
                case 1:
                    movieSelected = _a.sent();
                    ...
                    return [4 /*yield*/, inputFavourite(movieId, userId)];
                case 2:
                    _a.sent();
                    return [2 /*return*/, (movieSelected.movie)];
            }
        });
    });
}
